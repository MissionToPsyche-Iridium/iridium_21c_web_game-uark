...
namespace ChristinaCreatesGames.Typography.Typewriter
{
    ...
    public class TypewriterEffect : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (_textBox == null)
            {
                Debug.LogError("TypewriterEffect: TMP_Text component is missing!", this);
            }
        ...
        public void RestartEffect()
        {
            if (_textBox == null)
            {
                Debug.LogError("TypewriterEffect: TMP_Text component is missing! Make sure this script is attached to a TextMeshPro object.", this);
                return;
            }

            if (!gameObject.activeInHierarchy)
            {
                Debug.LogWarning("TypewriterEffect: GameObject is inactive, skipping effect.");
                return;
            }

            _textBox.enabled = true;  // Ensure text is visible
            _textBox.maxVisibleCharacters = 0;
            _currentVisibleCharacterIndex = 0;
